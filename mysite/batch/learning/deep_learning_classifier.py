...
class DeepLearner(BaseClassifier):
    ...
    def __init__(self):
        super().__init__()
        self.x = tf.placeholder(tf.float32, shape=[None, 0])   ### Input
    ...
    def set_model(self, input_dim = 0, n_layer1 = 10, n_layer2 = 10, learning_rate = 0.1):
        ...
        self.set_cross_ent()
        self.set_train_step(learning_rate)
        self.set_accuracy()
    ...
    def classify(self, data):
        return self.model.eval(session=sess, feed_dict={self.x:data, self.keep_prob:1.0})
